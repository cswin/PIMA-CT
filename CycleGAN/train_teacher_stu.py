...
parser.add_argument('--model', default='teacher_stu_unet64_basic_iden_30', type=str, help='choose a type of model')
...
parser.add_argument('--result_pseudo', default='../dataset/CT_Data_All_Patients/pseudo1', type=str, help='path of pseudo dictionary')
...
if initial_time != 0:
    ...
    mixed_data = torch.cat((xs, pseudo_data), 0)
    DDataset = AlignedDenoisingDataset(mixed_data)
    DLoader = DataLoader(dataset=DDataset, num_workers=4, drop_last=True, batch_size=args.batch_size, shuffle=True)

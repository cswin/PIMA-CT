# -*- coding: utf-8 -*-
# @Time    : 2019/12/29 15:02
# @Author  : xls56i

# 重写 dataloader 和 loss
...
class CycleGANModel():
    ...
    def set_input(self, input):
        self.real_A = input['noise_free'].to(self.device) # noise_free 病人和phantom high-dose
        self.real_B = input['real_noise'].to(self.device) # phantom low-dose

...
parser.add_argument('--model', default='DnCNNA-simulation-gaussian-30mAs_liangci_tuihua_0001-2020-3-5', type=str, help='choose a type of model')
...
parser.add_argument('--gaussian_noisy', default='../dataset/CT_Data_All_Patients/pseudo_gaussian30mAs', type=str,
                    help='path of pseudo dictionary')
...
data_realA = dg.realA_datagenerator(args.dataset_unlabeled, args.batch_size, args.aug_times,
...
data_realB = dg.realB_datagenerator(args.phantom_low, args.batch_size, args.aug_times,
                                              args.patch_size, args.stride, args.threshold)
data_align = dg.aligned_datagenerator(args.gaussian_noisy, args.dataset_unlabeled, args.batch_size, args.aug_times,
                                              args.patch_size, args.stride, args.threshold)
...
data_align1 = dg.aligned_datagenerator(args.result_pseudo, args.dataset_unlabeled, args.batch_size, args.aug_times,
                                          args.patch_size, args.stride, args.threshold)

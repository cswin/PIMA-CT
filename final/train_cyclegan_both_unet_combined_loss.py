...
from cyclegan_model_both_unet import CycleGANModel
import os, time
import cv2
import numpy as np
...
parser.add_argument('--model', default='Cyclegan-both-unet-combinedloss-simulation-30mAs', type=str, help='choose a type of model')
...
parser.add_argument('--pretrainGB', default='../CycleGAN/models/pretrainGB.pth', type=str)

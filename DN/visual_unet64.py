...
parser.add_argument('--model', default='visual_unet64_basic_TVLoss_2_7_1', type=str, help='choose a type of model')
parser.add_argument('--lambda1', default=0.1, type=float, help='adver loss')
parser.add_argument('--lambda2', default=0.1, type=float, help='rec loss')
parser.add_argument('--lambda3', default=0.1, type=float, help='TV loss')
...
if __name__ == '__main__':
    ...
    for epoch in range(initial_epoch, args.epoch):
        ...
        for i, data in enumerate(DLoader, 0):
            ...
            errG2 = criterion(fake, real_cpu)/((fake.shape[0]/output.shape[0])**2)
            errG3 = criterion1(fake)/(2*(fake.shape[0]/output.shape[0])**2)
